        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item {{$key == 0 ? 'active' : ''}}">
                ...
                <div class="carousel-caption my-caption">
                    ...
                    <p class="">Offer Last Date: {{$offer_course->offer_Date}}</p>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <img src="{{asset($recent_course->image)}}" alt="" class="h-100"/>
                        <div class="card-body">
                            <h4><a href="{{route('training.detail' , ['id' => $recent_course->id])}}" class="text-decoration-none text-black">{{$recent_course->title}}</a></h4>
                            <p class="mb-0">Tk. {{$recent_course->fee}}</p>
                            <p class="py-0">Starting Date:{{$recent_course->starting_date}}</p>
                            <hr/>
                ...
                @foreach($popular_courses as $popular_course)
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <h4><a href="{{route('training.detail' , ['id' => $popular_course->id])}}" class="text-decoration-none text-black">{{$popular_course->title}}</a></h4>
                                <p class="mb-0">Tk. {{$popular_course->fee}}</p>
                                <p class="py-0">Starting Date:{{$popular_course->starting_date}}</p>
                                <hr/>
