            ...
            <div class="row mt-5">
                <div class="col-md-8 mx-auto">
                    <div class="card border-0 shadow">
                        <div class="card-header text-center display-6 fw-bold">Course Enroll Form</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('training.new-enroll' , ['id' => $id])}}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" @if(Session::get('student_id')) value="{{$student->email}}" readonly @endif class="form-control" name="email" id="email"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" @if(Session::get('student_id')) value="{{$student->mobile}}" readonly @endif class="form-control" name="mobile"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
