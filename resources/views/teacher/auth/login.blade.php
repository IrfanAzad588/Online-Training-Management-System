        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="bg-soft-primary">
                        <div class="row">
                            ...
                            <div class="col-5 align-self-end">
                                <img src="{{asset('/')}}admin/assets/teacher-image/blackshirt.jpg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-0">
                            ...
                            <a href="index.html">
                                <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{asset('/')}}admin/assets/images/users/avatar-1.jpg" alt="" class="rounded-circle" height="34">
                                            </span>
                                </div>
                            </a>
                        </div>
                        <div class="p-2">
                            ...
                            <form class="form-horizontal" action="{{route('teacher.login')}}" method="POST">
                                ...
                                <div class="mt-4 text-center">
                                    <a href="admin/auth-recoverpw.html" class="text-muted"><i class="mdi mdi-lock mr-1"></i> Forgot your password?</a>
                                </div>
                            </form>
                        </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        <p>Don't have an account ? <a href="admin/auth-register.html" class="font-weight-medium text-primary"> Signup now </a> </p>
