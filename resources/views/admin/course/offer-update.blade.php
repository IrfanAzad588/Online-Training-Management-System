        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.update-course-offer' , ['id' =>$course->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        <label for="horizontal-password-input" class="col-sm-3 col-form-label">Actual Fee</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mb-4">
                        <label for="horizontal-password-input" class="col-sm-3 col-form-label">Offer Image</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control-file" id="horizontal-password-input4 " name="image">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="horizontal-password-input" class="col-sm-3 col-form-label">Offer Date</label>
                        <div class="col-sm-9">
