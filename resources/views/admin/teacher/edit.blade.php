                ...
                <div class="card-body">
                    ...
                    <form action="{{route('teacher.update' , ['id' => $teacher->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" value="{{$teacher->email}}" id="horizontal-email-input" name="email"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input" class="col-sm-3 col-form-label">Password</label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control" value="" id="horizontal-password-input" name="password"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input2" class="col-sm-3 col-form-label">Mobile Number</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" value="{{$teacher->mobile}}" id="horizontal-password-input2" name="mobile"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
