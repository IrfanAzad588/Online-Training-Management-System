        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Add Enroll information</h4>
...
{{--                                <td>{{$enroll->student->name.'('.$enroll->student->mobile.')'}}</td>--}}
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.edit-enroll-status' , ['id' => $enroll->id])}}" class="btn btn-outline-primary {{$enroll->enroll_status == 'Complete' ? 'disabled' : ''}}">
