...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'),'verified'])->group(function () {
    ...
    Route::get('/admin/user', [AdminUserController::class, 'index'])->name('add.user');
    Route::post('/add/user', [AdminUserController::class, 'create'])->name('user.create');
    Route::get('/manage/user', [AdminUserController::class, 'manage'])->name('admin.user.manage');
